#luca braga ravanelli ra: 588271
#BCC 4ANO 7P
...
class Pipe():
    ...
    def __init__(self, x):
        ...
        # onde o "pipe" de cima e baixo estão
        self.top = 0
        self.bottom = 0
    ...
    def move(self):
        """
        mover o pipe com base na velocidade
        :return: None
        """
        self.x -= self.VEL
...
def draw_window(win, birds, pipes, base, score, gen, pipe_ind):
    ...
    # vivos
    score_label = STAT_FONT.render("Vivo(s): " + str(len(birds)),1,(255,255,255))
